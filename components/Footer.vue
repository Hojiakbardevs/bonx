    ...
    <div>
        ...
        <div class="bg-gray-800 py-5">
            ...
            <div class="container flex justify-between relative items-center md:flex-row flex-col-reverse">
                <p class="text-gray-500 text-sm uppercase font-medium mb-0">Wondercode.uz Copyrighted © 2020-2024 <i class="icofont-heart text-primary"></i>  by <a href="https://hasthemes.com" class="transition-all hover:text-primary text-white">WonderCode team</a></p>
                <client-only>
                    <back-to-top class="md:absolute-center position-absolute cursor-pointer z-999 left-3/4 md:left-1/2 mb-15 sm:mb-auto" bottom="auto" right="auto">
                        <img src="/images/icon/scroll-top.webp" alt="toper">
                    </back-to-top>
                </client-only>
